...
export async function sendTicketEmail(ticket) {
  const recipients = [
    ...
    {
      email: "Bayan.ali@spc-it.com.iq",
      title: "bayan ali",
    },

    
    // {
    //     email: "ali.mushtaqmcamt@gmail.com",
    //     title: "Ali Mushtaq",
    //   },
...
await transporter.sendMail({
  ...
  to: recipient.email,
  subject: ticket?.assignedTo
    ? `Ticket Assigned To ${ticket.assignedTo} | Created By ${ticket?.createdBy || "Unknown"}`
    : `Ticket Created By ${ticket?.createdBy || "Unknown"}`,
  html,
});
  }
}